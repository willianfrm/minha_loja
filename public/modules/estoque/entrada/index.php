...
// Buscar lista de motivos de entrada para o filtro
$motivos = $pdo->query("SELECT codigo, nome_motivo FROM motivo_movimentacoes WHERE tipo='E'")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
  <meta charset="UTF-8">
  <title>Movimentações de Entrada</title>
...
<div class="container mt-4">
  ...
  <button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#modalAdd">Nova Entrada</button>
  ...
  <div class="modal-dialog modal-lg">
    <form method="POST" action="add.php" class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Nova Movimentação de Entrada</h5>
